...
def test_simple():
    transpile_and_validate(control_flow)
    transpile_and_validate(compound_assignment)
    transpile_and_validate(power_operator)
    transpile_and_validate(vertical_iteration_variable)
